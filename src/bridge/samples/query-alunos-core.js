...
`
  ...
  return new Promise(function (resolve, reject) {
    sqlRun(query, (data) => {
      ...
      let lastFileName = history.get('alunos_core_last')
      if(lastFileName == undefined) {
        history.set('alunos_core_before',fileName)
      } else {
        history.set('alunos_core_before',lastFileName)
      }
      history.set('alunos_core_last',fileName)

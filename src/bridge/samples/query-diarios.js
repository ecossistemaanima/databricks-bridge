...
`
  ...
  return new Promise(function (resolve, reject) {
    sqlRun(query, (data) => {
      ...
      let lastFileName = history.get('diarios_last')
      if(lastFileName == undefined) {
        history.set('diarios_before',fileName)
      } else {
        history.set('diarios_before',lastFileName)
      }
      history.set('diarios_last',fileName)
